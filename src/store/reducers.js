...
reducers receive objects from actions (src/actions) via containers (src/components/containers) and pass them to the redux store
...
the user reducer is combined with the post reducer by the store by the storeFactory (src/store/storeFactory) to instantiate the store
